...
namespace Genexus.Word
{
    public class WordServerDocument : IDisposable
    {
        ...
        private SearchTextReplaceStrategy strategy;
        ...
        public void AddStyle(string styleId, string styleName, List<string> properties)
        {
            ...
            styleRunProperties1.Append(Helper.GetProperties(properties));
        ...
        public static Run GetTextRun(string text, List<string> properties)
        {
            ...
            if (properties != null)
            {
                r.Append(new RunProperties(Helper.GetProperties(properties)));
            }
        ...
        public int ReplaceTextWithStyle(string searchText, string replaceText, bool matchCase, List<string> properties)
        {
            ...
            {
                if (ContainsText(para.InnerText, searchText, matchCase))
                {
                    int paragraphReplaceCount = strategy.ReplaceText(para, searchText, replaceText, matchCase, properties);
                    count += paragraphReplaceCount;
                }
            }
            return count;
        }
        ...
        private static bool ContainsText(string text, string searchText, bool matchCase)
        {
            return (matchCase) ? text.Contains(searchText) : text.ToLower().Contains(searchText.ToLower());
